    ...
    return (
        <div className="account-container">
            <div className="sidebar">
                <a href="icon">👤</a>
                <button onClick={() => handleViewChange('details')} className={currentView === 'details' ? 'active' : ''}>
                    Details
                </button>
                <button onClick={() => handleViewChange('settings')} className={currentView === 'settings' ? 'active' : ''}>
                    Settings
                </button>
